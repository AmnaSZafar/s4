        ...
        return(
            ...
            <section id="hero" className="d-flex align-items-center justify-content-center">
              <div className="container position-relative">
                ...
                <h2 style={{fontStyle: 'bold'}}>International Certifications  |<span className="font-weight-bold" style={{color: '#ffc107'}}> Scholarships for Toppers (No Certification Fee) <br />Remote Course Internship Access for Outstationed candidates, Graduate Students, Working Professionals &amp; Females</span> | International Trainers</h2>
